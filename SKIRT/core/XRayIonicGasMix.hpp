...
private:
    ...
    int _numRes;   // number of resonant scattering transitions
    

    // persistent data for scattering
    vector<IonParam> _ionParamv;
    vector<FluorescenceParam> _fluorescenceParamv;
    vector<ResonanceLineParam> _resonanceParamv;
    vector<double> _vthermv;  // indexed on Z
    std::map<std::pair<int, int>, int> _resonanceParamIndexForLine;
